/**
 * This is a copy of the AsyncPipe
 *
 * Only differences:
 * 1. stub for error handling since I'm lazy (line 163)
 * 2. replaced `this._ref!.markForCheck()` with `this._ref!.detectChanges()` (line 181)
 *
 * Hello fine-grained reactivity using rxjs and Angular
 */
...
export class MyAsyncPipe implements OnDestroy, PipeTransform {
  ...
  private _selectStrategy(obj: Subscribable<any>|Promise<any>|
    ...
    throw new Error('invalidPipeArgumentError');
  }
